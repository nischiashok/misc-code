...
resource "azurerm_network_interface" "privateip" {
  ...
  ip_configuration {
    name                          = var.name
    subnet_id                     = "/subscriptions/e0be8e24-25e7-4901-ad14-ea389c0f1289/resourceGroups/project-setup-1/providers/Microsoft.Network/networkInterfaces/workstation3"
